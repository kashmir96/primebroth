...
<table width="100%" style="max-width:520px;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
  ...
  <tr><td style="padding:32px;">
    ...
    <p style="margin:0 0 8px;font-size:0.85rem;color:#877B71;line-height:1.6;">
      ...
      ${newBalance >= 2000 ? `<strong style="color:#3D5230;">You have enough to redeem right now!</strong>` : `Keep earning — you're ${(2000 - newBalance).toLocaleString()} pts away from your first redemption.`}
    </p>

    <p style="margin:16px 0 0;font-size:0.78rem;color:#C8A87A;">
      ⭐ <strong>What are PrimalPoints?</strong> Earn 100 points per $1 spent. That's 5% back — redeem 2,000 points for $1 off.
    </p>
  </td></tr>
