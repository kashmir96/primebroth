...
<table width="100%" style="max-width:520px;background:#1a1008;border-radius:16px;overflow:hidden;border:1px solid rgba(200,168,122,0.3);">
  ...
  <tr><td style="padding:20px 32px;border-top:1px solid rgba(200,168,122,0.15);text-align:center;">
    <p style="margin:0;font-size:0.78rem;color:rgba(255,255,255,0.45);line-height:1.7;">
      ...
      Earn on every purchase. Redeem for dollars off. 100 pts = $1.
    </p>
  </td></tr>
...
<table width="100%" style="max-width:520px;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
  ...
  <tr><td style="padding:32px;">
    ...
    <div style="background:#f5f0e8;border-radius:10px;padding:18px;margin-bottom:20px;">
      ...
      <p style="margin:0;font-size:1.5rem;font-weight:800;color:#3D5230;">$${(balance / 100).toFixed(2)} off</p>
      <p style="margin:4px 0 0;font-size:0.72rem;color:#877B71;">at 100 points = $1</p>
    </div>
    ${balance >= 500 ? `<a href="${redeemUrl || 'https://www.primalpantry.co.nz'}" style="display:block;background:#3D5230;color:#fff;text-decoration:none;padding:14px;border-radius:10px;font-weight:700;text-align:center;font-size:0.9rem;">Redeem my points →</a>` : `<p style="margin:0;font-size:0.82rem;color:#877B71;">You need 500 points to start redeeming. Keep earning!</p>`}
    <p style="margin:16px 0 0;font-size:0.75rem;color:#C8A87A;">⭐ <strong>Earning rate:</strong> 100 points per $1 spent. Points expire 60 days after they're earned.</p>
  </td></tr>
...
<table width="100%" style="max-width:520px;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
  ...
  <tr><td style="padding:32px;">
    ...
    <p style="margin:0 0 20px;font-size:0.85rem;color:#877B71;line-height:1.6;">
      Your total balance is <strong style="color:#3D5230;">${balance.toLocaleString()} pts</strong> — worth <strong style="color:#3D5230;">$${(balance / 100).toFixed(2)}</strong> off your next order.
    </p>
