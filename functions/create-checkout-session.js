...
exports.handler = async (event, context) => {
  try {
    ...
    // Add ALL possible shipping rates for NZ & AU upfront (Stripe will filter based on user selection)
    ...
    console.log(`Shipping rates loaded for NZ & AU:`, JSON.stringify(shippingOptions));
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      shipping_options: shippingOptions, // Now sending ALL options upfront
